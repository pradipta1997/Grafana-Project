                    ...
                    <div class="form-group">
                        <div class="col-sm" style="width: 100%;">
                            <div>
                                ...
                                <a class="col-sm-" href="MonitoringOutstandingShortageBGSelindo22" style="color: #013a63;">Monitoring Outstanding Shortage BG Selindo 2022 <b style="color:orange;"> (RDI) |</b> </a>
...
<script>
    const urlMonitoringOutstandingShortageBGSelindo22 = '<?= site_url("MonitoringOutstandingShortageBGSelindo22/") ?>';
    let table;
    ...
    $(function() {
        if (!$.fn.DataTable.isDataTable('#tableBarang')) {
            table = $('#tableBarang').DataTable({
                ...
                scrollX: true,
                ajax: {
                    url: urlMonitoringOutstandingShortageBGSelindo22 + "listMonitoringOutstandingShortageBGSelindo22",
                    type: "POST"
                },
                columnDefs: [{
                    targets: [0, -1],
