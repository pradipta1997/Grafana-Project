                    ...
                    <table id="tableBarang" class="table table-bordered table-striped" style="width: 100%;">
                        <thead style="background-color: #012a4a; color: white;">
                            <tr role="row">
                                ...
                                <th>TK (100)</th>
                                <th>Grand Total</th>
                                <th>Average Kas Per ATM (50)</th>
                                <th>Average Kas Per ATM (100)</th>
                                <th>User</th>
...
<script>
    const urlFormatProyeksiKebutuhanKasBGSelindo = '<?= site_url("FormatProyeksiKebutuhanKasBGSelindo/") ?>';
    let table;
    ...
    $(function() {
        if (!$.fn.DataTable.isDataTable('#tableBarang')) {
            table = $('#tableBarang').DataTable({
                ...
                scrollX: true,
                ajax: {
                    url: urlFormatProyeksiKebutuhanKasBGSelindo + "listFormatProyeksiKebutuhanKasBGSelindo",
                    type: "POST"
                },
                columnDefs: [{
                    targets: [0, -1],
