                    ...
                    <table id="tableBarang" class="table table-bordered table-striped" style="width: 100%;">
                        <thead style="background-color: #012a4a; color: white;">
                            <tr role="row">
                                ...
                                <th>BC</th>
                                <th>KANTOR CABANG</th>
                                <th>POSISI UTLE DI BRANKAS 100000</th>
                                <th>POSISI UTLE DI BRANKAS 50000</th>
                                <th>POSISI UTLE DI BRANKAS TOTAL</th>
                                <th>Posisi Tanggal</th>
                                <th>POSISI UTLE DI BRANKAS 100000 (2)</th>
                                <th>POSISI UTLE DI BRANKAS 50000 (2)</th>
                                <th>POSISI UTLE DI BRANKAS TOTAL (2)</th>
                                <th>Posisi Tanggal (2)</th>
                                <th>Keterangan</th>
                                <th>User</th>
...
<script>
    const urlRekapLaporanPosisiKasUTLE = '<?= site_url("RekapLaporanPosisiKasUTLE/") ?>';
    let table;
    ...
    $(function() {
        if (!$.fn.DataTable.isDataTable('#tableBarang')) {
            table = $('#tableBarang').DataTable({
                ...
                scrollX: true,
                ajax: {
                    url: urlRekapLaporanPosisiKasUTLE + "listRekapLaporanPosisiKasUTLE",
                    type: "POST"
                },
                columnDefs: [{
                    targets: [0, -1],
