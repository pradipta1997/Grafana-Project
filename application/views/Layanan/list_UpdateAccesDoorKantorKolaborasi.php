                    ...
                    <div class="form-group">
                        <div class="col-sm" style="width: 100%;">
                            <div>
                                ...
                                <a class="col-sm-" href="RekapMonitoringPelanggaranSOPkcSelindo" style="color: #013a63;">Rekap Monitoring Pelanggaran SOP KC Selindo <b style="color:orange;"> (SIU) |</b> </a>
                                <a class="col-sm-" href="UpdateAccesDoorKantorKolaborasi" style="color: #013a63;">Update Acces Door Kantor Kolaborasi <b style="color:orange;"> (SIU) |</b> </a>
                ...
                <div class="panel-body">
                    <table id="tableBarang" class="table table-bordered table-striped" style="width: 100%;">
                        <thead style="background-color: #012a4a; color: white;">
                            <tr role="row">
                                <th>No</th>
                                <th>Update Data Access Door Kantor Kolaborasi</th>
                                <th>User</th>
...
<script>
    const urlUpdateAccesDoorKantorKolaborasi = '<?= site_url("UpdateAccesDoorKantorKolaborasi/") ?>';
    let table;
    ...
    $(function() {
        if (!$.fn.DataTable.isDataTable('#tableBarang')) {
            table = $('#tableBarang').DataTable({
                ...
                scrollX: true,
                ajax: {
                    url: urlUpdateAccesDoorKantorKolaborasi + "listUpdateAccesDoorKantorKolaborasi",
                    type: "POST"
                },
                columnDefs: [{
                    targets: [0, -1],
