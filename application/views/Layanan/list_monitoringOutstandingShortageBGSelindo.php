                ...
                <header class="panel-heading">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2" style="width: 50%;" name="layanan" id="layanan">
                            ...
                            <option value="">Monitoring Outstanding Shortage BG Selindo 2022 (RDI)</option>
                    ...
                    <div class="form-group">
                        <div class="col-sm" style="width: 100%;">
                            <div>
                                ...
                                <a class="col-sm-" href="MonitoringOutstandingShortageBGSelindo" style="color: #013a63;">Monitoring Outstanding Shortage BG Selindo 2021 <b style="color:orange;"> (RDI) |</b> </a>
                                <a class="col-sm-" href="" style="color: #013a63;">Monitoring Outstanding Shortage BG Selindo 2022 <b style="color:orange;"> (RDI) |</b> </a>
                    ...
                    <table id="tableBarang" class="table table-bordered table-striped" style="width: 100%;">
                        <thead style="background-color: #012a4a; color: white;">
                            <tr role="row">
                                ...
                                <th>Frekuensi</th>
                                <th>Nominal</th>
                                <th>Frekuensi Kasus New</th>
                                <th>Frekuensi Kasus Open</th>
                                <th>Frekuensi Kasus Close</th>
                                <th>Frekuensi Kasus</th>
                                <th>Progress Mingguan</th>
                                <th>Closed Case Done</th>
                                <th>Closed Case Progress</th>
                                <th>Pending Jan-Sept</th>
                                <th>Pending Oktober</th>
                                <th>All Pending</th>
                                <th>User</th>
...
<script>
    const urlMonitoringOutstandingShortageBGSelindo = '<?= site_url("MonitoringOutstandingShortageBGSelindo/") ?>';
    let table;
    ...
    $(function() {
        if (!$.fn.DataTable.isDataTable('#tableBarang')) {
            table = $('#tableBarang').DataTable({
                ...
                scrollX: true,
                ajax: {
                    url: urlMonitoringOutstandingShortageBGSelindo + "listMonitoringOutstandingShortageBGSelindo",
                    type: "POST"
                },
                columnDefs: [{
                    targets: [0, -1],
