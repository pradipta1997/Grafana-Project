                    ...
                    <table id="tableBarang" class="table table-bordered table-striped" style="width: 100%;">
                        <thead style="background-color: #012a4a; color: white;">
                            <tr role="row">
                                ...
                                <th>Kantor Cabang</th>
                                <th>Avg.</th>
                                <th>Tier Invoice (Before)</th>
                                <th>Total Qty ATM</th>
                                <th>Proyeksi Pendapatan Sebelum Sanggahan</th>
                                <th>Reliability (%)</th>
                                <th>Δ Relia (%)</th>
                                <th>Tier Invoice (After)</th>
                                <th>V3 G</th>
                                <th>V3 NG</th>
                                <th>V4 G</th>
                                <th>V4 NG</th>
                                ...
                                <th>Selisih Pendapatan Dgn Sebelum Sanggahan</th>
                                <th>User</th>
...
<script>
    const urlProyeksiNilaiSanggahan = '<?= site_url("ProyeksiNilaiSanggahan/") ?>';
    let table;
    ...
    $(function() {
        if (!$.fn.DataTable.isDataTable('#tableBarang')) {
            table = $('#tableBarang').DataTable({
                ...
                scrollX: true,
                ajax: {
                    url: urlProyeksiNilaiSanggahan + "listProyeksiNilaiSanggahan",
                    type: "POST"
                },
                columnDefs: [{
                    targets: [0, -1],
