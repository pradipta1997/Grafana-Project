                    ...
                    <table id="tableBarang" class="table table-bordered table-striped" style="width: 100%;">
                        <thead style="background-color: #012a4a; color: white;">
                            <tr role="row">
                                ...
                                <th>RETURN (100)</th>
                                <th>JUMLAH</th>
                                <th>SALDO AWAL PAGI (50)</th>
                                <th>SALDO AWAL PAGI (100)</th>
                                <th>JUMLAH1</th>
                                <th>RPL PAGI (50)</th>
                                <th>RPL PAGI (100)</th>
                                <th>JUMLAH2</th>
                                <th>SALDO RESTOCKING PAGI (50)</th>
                                <th>SALDO RESTOCKING PAGI (100)</th>
                                <th>JUMLAH3</th>
                                <th>User</th>
...
<script>
    const urlSaldoRestockingTerpusat = '<?= site_url("SaldoRestockingTerpusat/") ?>';
    let table;
    ...
    $(function() {
        if (!$.fn.DataTable.isDataTable('#tableBarang')) {
            table = $('#tableBarang').DataTable({
                ...
                scrollX: true,
                ajax: {
                    url: urlSaldoRestockingTerpusat + "listSaldoRestockingTerpusat",
                    type: "POST"
                },
                columnDefs: [{
                    targets: [0, -1],
