...
<script>
    const urlMonitoringInstruksiInvestigasiShortageBGSelindo = '<?= site_url("MonitoringInstruksiInvestigasiShortageBGSelindo/") ?>';
    let table;
    ...
    $(function() {
        if (!$.fn.DataTable.isDataTable('#tableBarang')) {
            table = $('#tableBarang').DataTable({
                ...
                scrollX: true,
                ajax: {
                    url: urlMonitoringInstruksiInvestigasiShortageBGSelindo + "listMonitoringInstruksiInvestigasiShortageBGSelindo",
                    type: "POST"
                },
                columnDefs: [{
                    targets: [0, -1],
