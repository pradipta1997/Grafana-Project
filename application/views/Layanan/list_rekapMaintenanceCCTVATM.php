                    ...
                    <table id="tableBarang" class="table table-bordered table-striped" style="width: 100%;">
                        <thead style="background-color: #012a4a; color: white;">
                            <tr role="row">
                                ...
                                <th>JUMLAH ATM</th>
                                <th>WEEK 1 ON PROGRESS</th>
                                <th>WEEK 1 DONE</th>
                                <th>WEEK 2 ON PROGRESS</th>
                                <th>WEEK 2 DONE</th>
                                <th>WEEK 3 ON PROGRESS</th>
                                <th>WEEK 3 DONE</th>
                                <th>WEEK 4 ON PROGRESS</th>
                                <th>WEEK 4 DONE</th>
                                <th>User</th>
...
<script>
    const urlRekapMaintenanceCCTVATM = '<?= site_url("RekapMaintenanceCCTVATM/") ?>';
    let table;
    ...
    $(function() {
        if (!$.fn.DataTable.isDataTable('#tableBarang')) {
            table = $('#tableBarang').DataTable({
                ...
                scrollX: true,
                ajax: {
                    url: urlRekapMaintenanceCCTVATM + "listRekapMaintenanceCCTVATM",
                    type: "POST"
                },
                columnDefs: [{
                    targets: [0, -1],
