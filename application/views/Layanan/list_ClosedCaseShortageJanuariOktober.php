...
<script>
    const urlClosedCaseShortageJanuariOktober = '<?= site_url("ClosedCaseShortageJanuariOktober/") ?>';
    let table;
    ...
    $(function() {
        if (!$.fn.DataTable.isDataTable('#tableBarang')) {
            table = $('#tableBarang').DataTable({
                ...
                scrollX: true,
                ajax: {
                    url: urlClosedCaseShortageJanuariOktober + "listClosedCaseShortageJanuariOktober",
                    type: "POST"
                },
                columnDefs: [{
                    targets: [0, -1],
