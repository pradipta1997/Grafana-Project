                    ...
                    <table id="tableBarang" class="table table-bordered table-striped" style="width: 100%;">
                        <thead style="background-color: #012a4a; color: white;">
                            <tr role="row">
                                <th>No</th>
                                <th>Jumlah</th>
                                <th>Update Data CCTV Kolaborasi</th>
                                <th>User</th>
...
<script>
    const urlUpdateDataCctvKolaborasi = '<?= site_url("UpdateDataCctvKolaborasi/") ?>';
    let table;
    ...
    $(function() {
        if (!$.fn.DataTable.isDataTable('#tableBarang')) {
            table = $('#tableBarang').DataTable({
                ...
                scrollX: true,
                ajax: {
                    url: urlUpdateDataCctvKolaborasi + "listUpdateDataCctvKolaborasi",
                    type: "POST"
                },
                columnDefs: [{
                    targets: [0, -1],
