                    ...
                    <div class="form-group">
                        <div class="col-sm" style="width: 100%;">
                            <div>
                                ...
                                <a class="col-sm-" href="UpdateDataPassthru" style="color: #013a63;">Update Data Passthru <b style="color:orange;"> (SIU) |</b> </a>
                                <a class="col-sm-" href="UpdateDataPetugasSatpam" style="color: #013a63;">Update Data Petugas Satpam <b style="color:orange;"> (SIU) |</b> </a>
                                <a class="col-sm-" href="UpdateDataSimcardAlatAlarmSystem" style="color: #013a63;">Update Data Simcard Pada Alat Alarm System <b style="color:orange;"> (SIU) |</b> </a>
                                <a class="col-sm-" href="UpdateDataTemuanUnitSiu" style="color: #013a63;">Update Data Temuan Unit SIU <b style="color:orange;"> (SIU) |</b> </a>
                    ...
                    <table id="tableBarang" class="table table-bordered table-striped" style="width: 100%;">
                        <thead style="background-color: #012a4a; color: white;">
                            <tr role="row">
                                <th>No</th>
                                <th>Cabang</th>
                                <th>Kriteria Pelanggaran Admin</th>

                                <th>Kriteria Pelanggaran CPC</th>
                                <th>Kriteria Pelanggaran Gerbang Utama</th>
                                <th>Kriteria Pelanggaran Kunci</th>
                                <th>Kriteria Pelanggaran Khasanah</th>
                                <th>Kriteria Pelanggaran Loading</th>
                                <th>Kriteria Pelanggaran Passthru</th>
                                <th>Kriteria Pelanggaran Maintrap</th>

                                <th>Kriteria Pelanggaran Rutang</th>
                                <th>Kriteria Pelanggaran Steril</th>
                                <th>Kriteria Pelanggaran Kendaraan</th>
                                <th>Total Jumlah Pelanggaran</th>
                                <th>User</th>
...
<script>
    const urlUpdateDataTemuanUnitSiu = '<?= site_url("UpdateDataTemuanUnitSiu/") ?>';
    let table;
    ...
    $(function() {
        if (!$.fn.DataTable.isDataTable('#tableBarang')) {
            table = $('#tableBarang').DataTable({
                ...
                scrollX: true,
                ajax: {
                    url: urlUpdateDataTemuanUnitSiu + "listUpdateDataTemuanUnitSiu",
                    type: "POST"
                },
                columnDefs: [{
                    targets: [0, -1],
