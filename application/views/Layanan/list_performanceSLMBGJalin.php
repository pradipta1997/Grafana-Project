                    ...
                    <table id="tableBarang" class="table table-bordered table-striped" style="width: 100%;">
                        <thead style="background-color: #012a4a; color: white;">
                            <tr role="row">
                                ...
                                <th>Kantor Cabang</th>
                                <th>Jumlah Mesin</th>
                                <th>(%) Performance Reliability SLM Jalin</th>
                                <th>User</th>
...
<script>
    const urlPerformanceSLMBGJalin = '<?= site_url("PerformanceSLMBGJalin/") ?>';
    let table;
    ...
    $(function() {
        if (!$.fn.DataTable.isDataTable('#tableBarang')) {
            table = $('#tableBarang').DataTable({
                ...
                scrollX: true,
                ajax: {
                    url: urlPerformanceSLMBGJalin + "listPerformanceSLMBGJalin",
                    type: "POST"
                },
                columnDefs: [{
                    targets: [0, -1],
