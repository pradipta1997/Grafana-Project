                    ...
                    <table id="tableBarang" class="table table-bordered table-striped" style="width: 100%;">
                        <thead style="background-color: #012a4a; color: white;">
                            <tr role="row">
                                ...
                                <th>Kategori Anomali Cardless</th>
                                <th>Balancing Tidak Tertib RPL</th>
                                <th>Cocok/Surplus Berdasarkan Rekon EJ Trx</th>
                                <th>CPC Tidak Tertib</th>
                                <th>Indikasi Fraud</th>
                                <th>Kesalahan Rekon Membaca Billcounter</th>
                                <th>Vandalisme</th>
                                <th>Open</th>
                                <th>Grand Total</th>
                                <th>User</th>
...
<script>
    const urlUpdateKategoriKasusClosedCaseFrekuensi = '<?= site_url("UpdateKategoriKasusClosedCaseFrekuensi/") ?>';
    let table;
    ...
    $(function() {
        if (!$.fn.DataTable.isDataTable('#tableBarang')) {
            table = $('#tableBarang').DataTable({
                ...
                scrollX: true,
                ajax: {
                    url: urlUpdateKategoriKasusClosedCaseFrekuensi + "listUpdateKategoriKasusClosedCaseFrekuensi",
                    type: "POST"
                },
                columnDefs: [{
                    targets: [0, -1],
