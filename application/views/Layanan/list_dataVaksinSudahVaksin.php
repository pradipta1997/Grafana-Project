                ...
                <header class="panel-heading">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2" style="width: 50%;" name="layanan" id="layanan">
                            ...
                            <option value="data_vaksin_div_layanan_sudah_vaksin">Data Vaksin-Sudah Vaksin (DSP)</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm" style="width: 100%;">
                            <div>
                                ...
                                <a class="col-sm-" href="DataVaksinSudahVaksin" >Data Vaksin Sudah Vaksin (DSP) | </a>
                                <br> <hr>
                            </div>
                        </div>
                    </div>
...
<script>
    const urlDataVaksinSudahVaksin = '<?= site_url("DataVaksinSudahVaksin/") ?>';
    let table;
    ...
    $(function() {
        if (!$.fn.DataTable.isDataTable('#tableBarang')) {
            table = $('#tableBarang').DataTable({
                ...
                scrollX: true,
                ajax: {
                    url: urlDataVaksinSudahVaksin + "listDataVaksinSudahVaksin",
                    type: "POST"
                },
                columnDefs: [{
                    targets: [0, -1],
