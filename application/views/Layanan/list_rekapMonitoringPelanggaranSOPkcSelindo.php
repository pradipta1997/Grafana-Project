...
<script>
    const urlRekapMonitoringPelanggaranSOPkcSelindo = '<?= site_url("RekapMonitoringPelanggaranSOPkcSelindo/") ?>';
    let table;
    ...
    $(function() {
        if (!$.fn.DataTable.isDataTable('#tableBarang')) {
            table = $('#tableBarang').DataTable({
                ...
                scrollX: true,
                ajax: {
                    url: urlRekapMonitoringPelanggaranSOPkcSelindo + "listRekapMonitoringPelanggaranSOPkcSelindo",
                    type: "POST"
                },
                columnDefs: [{
                    targets: [0, -1],
