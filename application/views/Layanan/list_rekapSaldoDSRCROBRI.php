                    ...
                    <table id="tableBarang" class="table table-bordered table-striped" style="width: 100%;">
                        <thead style="background-color: #012a4a; color: white;">
                            <tr role="row">
                                ...
                                <th>BC</th>
                                <th>KANTOR CABANG</th>
                                <th>SALDO AWAL CRO</th>
                                <th>RETURN CRO</th>
                                <th>SALDO AKHIR CRO</th>
                                <th>SALDO AWAL DSR</th>
                                <th>RETURN DSR</th>
                                <th>SALDO AKHIR DSR</th>
                                <th>KETERANGAN</th>
                                <th>NOMINAL</th>
                                <th>KETERANGAN1</th>
                                <th>NOMINAL1</th>
...
<script>
    const urlRekapSaldoDSRCROBRI = '<?= site_url("RekapSaldoDSRCROBRI/") ?>';
    let table;
    ...
    $(function() {
        if (!$.fn.DataTable.isDataTable('#tableBarang')) {
            table = $('#tableBarang').DataTable({
                ...
                scrollX: true,
                ajax: {
                    url: urlRekapSaldoDSRCROBRI + "listRekapSaldoDSRCROBRI",
                    type: "POST"
                },
                columnDefs: [{
                    targets: [0, -1],
