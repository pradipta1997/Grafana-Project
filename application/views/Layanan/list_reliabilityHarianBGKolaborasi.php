                ...
                <header class="panel-heading">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2" style="width: 50%;" name="layanan" id="layanan">
                            ...
                            <option value="Reability Harian BG Kolaborasi">Reability Harian BG Kolaborasi (ANEV)</option>
                    ...
                    <div class="form-group">
                        <div class="col-sm" style="width: 100%;">
                            <div>
                                ...
                                <a class="col-sm-" href="ReliabilityHarianBGKolaborasi" style="color: #013a63;">Reliability Harian BG Kolaborasi <b style="color:orange;"> (ANEV) |</b> </a>
                    ...
                    <table id="tableBarang" class="table table-bordered table-striped" style="width: 100%;">
                        <thead style="background-color: #012a4a; color: white;">
                            <tr role="row">
                                ...
                                <th>Jam Capture (6)</th>
                                <th>Jam Capture (9)</th>
                                <th>Jam Capture (12)</th>
                                <th>Jam Capture (15)</th>
                                <th>Jam Capture (18)</th>
                                <th>Jam Capture (21)</th>
                                <th>Average</th>
                                <th>User</th>
...
<script>
    const urlReliabilityHarianBGKolaborasi = '<?= site_url("ReliabilityHarianBGKolaborasi/") ?>';
    let table;
    ...
    $(function() {
        if (!$.fn.DataTable.isDataTable('#tableBarang')) {
            table = $('#tableBarang').DataTable({
                ...
                scrollX: true,
                ajax: {
                    url: urlReliabilityHarianBGKolaborasi + "listReliabilityHarianBGKolaborasi",
                    type: "POST"
                },
                columnDefs: [{
                    targets: [0, -1],
