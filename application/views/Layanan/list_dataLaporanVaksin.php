                    ...
                    <div class="form-group">
                        <div class="col-sm" style="width: 100%;">
                            <div>
                                ...
                                <a class="col-sm-" href="DataLapVaksin" >Data Laporan Vaksin (DSP) | </a>
                            </div>
                        </div>
                    </div>
                </header>
...
<script>
    const urlDataLapVaksin = '<?= site_url("DataLapVaksin/") ?>';
    let table;
    ...
    $(function() {
        if (!$.fn.DataTable.isDataTable('#tableBarang')) {
            table = $('#tableBarang').DataTable({
                ...
                scrollX: true,
                ajax: {
                    url: urlDataLapVaksin + "listdataLapVaksin",
                    type: "POST"
                },
                columnDefs: [{
                    targets: [0, -1],
