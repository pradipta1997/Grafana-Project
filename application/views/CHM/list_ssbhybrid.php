                    ...
                    <table id="tableBarang" class="table table-bordered table-striped" style="width: 100%;">
                        <thead style="background-color: #282828; color: white;">
                            <tr role="row">
                                ...
                                <th>Port</th>
                                <th>Ip Addrress</th>
                                <th>SN Card E-ktp Reader</th>
                                <th>Jenis E-ktp Reader</th>
                                <th>Kanwil</th>
                                <th>KC Supervisi</th>
                                ...
                                <th>Tanggal PM 3</th>
                                <th>Teknisi PM 3</th>
                                <th>STATUS 25 JUL 21 - 24 AGS 21</th>
                                <th>TEKNISI 25 JUL 21 - 24 AGS 21</th>
                                <th>TANGGAL 25 JUL 21 - 24 AGS 21</th>
                                <th>KETERANGAN 25 JUL 21 - 24 AGS 21</th>
                                <th>STATUS 25 AGS 21 - 24 SEP 21</th>
                                <th>TEKNISI 25 AGS 21 - 24 SEP 21</th>
                                <th>TANGGAL 25 AGS 21 - 24 SEP 21</th>
                                <th>KETERANGAN 25 AGS 21 - 24 SEP 21</th>
                                <th>STATUS 25 SEP 21 - 24 OKT 21</th>
                                <th>TEKNISI 25 SEP 21 - 24 OKT 21</th>
                                <th>TANGGAL 25 SEP 21 - 24 OKT 21</th>
                                <th>KETERANGAN 25 SEP 21 - 24 OKT 21</th>
                                <th>User</th>
...
<script>
    const urlSsbhybrid = '<?= site_url("Ssbhybrid/") ?>';
    let table;
    ...
    $(function() {
        if (!$.fn.DataTable.isDataTable('#tableBarang')) {
            table = $('#tableBarang').DataTable({
                ...
                scrollX: true,
                ajax: {
                    url: urlSsbhybrid + "listSsbhybrid",
                    type: "POST"
                },
                columnDefs: [{
                    targets: [0, -1],
