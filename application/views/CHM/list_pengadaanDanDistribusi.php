...
<script>
    const urlPengadaanDanDistribusiPO = '<?= site_url("PengadaanDanDistribusiPO/") ?>';
    let table;
    ...
    $(function() {
        if (!$.fn.DataTable.isDataTable('#tableBarang')) {
            table = $('#tableBarang').DataTable({
                ...
                scrollX: true,
                ajax: {
                    url: urlPengadaanDanDistribusiPO + "listPengadaanDanDistribusiPO",
                    type: "POST"
                },
                columnDefs: [{
                    targets: [0, -1],
