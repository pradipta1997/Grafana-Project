                    ...
                    <table id="tableBarang" class="table table-bordered table-striped" style="width: 100%;">
                        <thead style="background-color: #012a4a; color: white;">
                            <tr role="row">
                                ...
                                <th>Unit Kerja</th>
                                <th>Total Pekerja</th>
                                <th>Belum Boleh Vaksin</th>
                                <th>Sudah Vaksin</th>
                                <th>Belum Terdaftar Vaksin</th>
                                <th>Terdaftar Vaskin</th>
                                <th>Persentase Belum Boleh Vaksin</th>
                                <th>Persentase Sudah Vaksin</th>
                                <th>Persentase Belum Terdaftar Vaksin</th>
                                <th>Pembina</th>
                                <th>Keterangan</th>
                                <th>User</th>
...
<script>
    const urlDatapembina = '<?= site_url("Datapembina/") ?>';
    let table;
    ...
    $(function() {
        if (!$.fn.DataTable.isDataTable('#tableBarang')) {
            table = $('#tableBarang').DataTable({
                ...
                scrollX: true,
                ajax: {
                    url: urlDatapembina + "listDatapembina",
                    type: "POST"
                },
                columnDefs: [{
                    targets: [0, -1],
