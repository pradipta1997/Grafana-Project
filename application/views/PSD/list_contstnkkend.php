                    ...
                    <table id="tableBarang" class="table table-bordered table-striped" style="width: 100%;">
                        <thead style="background-color: #012a4a; color: white;">
                            <tr role="row">
                                ...
                                <th>No Polisi</th>
                                <th>Kendaraan</th>
                                <th>Pajak Tahunan (Tanggal)</th>
                                <th>Pajak Tahunan (Sisa Hari)</th>
                                <th>Lima Tahunan (Tanggal)</th>
                                <th>Lima Tahunan (Sisa Hari)</th>
                                <th>Keterangan</th>
                                <th>User</th>
...
<script>
    const urlContstnkkend = '<?= site_url("Contstnkkend/") ?>';
    let table;
    ...
    $(function() {
        if (!$.fn.DataTable.isDataTable('#tableBarang')) {
            table = $('#tableBarang').DataTable({
                ...
                scrollX: true,
                ajax: {
                    url: urlContstnkkend + "listContstnkkend",
                    type: "POST"
                },
                columnDefs: [{
                    targets: [0, -1],
