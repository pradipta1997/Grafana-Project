...
class MonitoringOutstandingShortageBGSelindo22 extends MY_Controller
{
    ...
    public function index()
    {
        ...
        // cekPergroup();
        $this->header('Monitoring Outstanding Shortage BG Selindo 2022');
        $this->load->view('Layanan/list_monitoringOutstandingShortageBGSelindo22', $data);
        $this->footer();
    }

    public function listMonitoringOutstandingShortageBGSelindo22()
    {
        // $list = $this->General->fetch_CoustomQuery("SELECT * FROM db_layanan.gps_kendaraan ORDER BY gps_kendaraan.TAHUN ASC");
        // cetak_die($list);

        $list = $this->Serverside->_serverSide(
            'Div_Layanan.Monitoring_Outstanding_Shortage_BG_Selindo_22',
        ...
        $output = array(
            "draw" => $_POST['draw'],
            "recordsTotal" => $this->Serverside->_countAll('Div_Layanan.Monitoring_Outstanding_Shortage_BG_Selindo_22'),
            "recordsFiltered" => $this->Serverside->_serverSide('Div_Layanan.Monitoring_Outstanding_Shortage_BG_Selindo_22'),
            "data" => $data,
        );
